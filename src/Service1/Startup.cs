...
{
    public static readonly ActivitySource ActivitySource = new("Genetec.Service1", "1.0");

    public static readonly Meter Meter = new("Genetec.Service1", "v1.0");
...
#pragma warning restore SA1306 // Field names should begin with lower-case letter
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddHttpClient("Service2", c =>
        {
            c.BaseAddress = new Uri(Configuration.GetValue<string>("SERVICE2_ENDPOINT"));

            c.DefaultRequestHeaders.Add("Accept", "application/json");

            // Github requires a user-agent
            c.DefaultRequestHeaders.Add("User-Agent", "Service1");
        });

        services.AddOpenTelemetryTracing(builder =>
            builder
                .SetResourceBuilder(ResourceBuilder.CreateDefault().AddService("Service1"))
                .AddSource("Genetec.Service1")
